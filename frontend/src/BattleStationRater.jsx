        ...
        <div className="flex flex-col lg:flex-row gap-8 justify-center items-start">
              ...
              >
                ...
                {!preview ? (
                  <div className="space-y-4">
                    <p className="text-[10px] leading-loose text-[#888]">
                      DRAG IMAGE HERE
                      <br />— OR —
                    </p>
          ...
          {result && !isScanning && (
            <div className="w-full lg:flex-1 bg-[#111] border-4 border-dashed border-[#ffcc00] p-6 animate-in fade-in slide-in-from-bottom-4">
              ...
              <h2 className="text-2xl text-[#00ff00] my-3">
                SCORE: {result.score}/100
              </h2>
              <p className="text-[#ff0055] text-[10px] leading-relaxed mb-4">
                STATUS: {result.status}
              </p>

              <div className="relative w-full bg-[#111] mb-6 border-4 border-[#222]">
                <img
                  src={result.image}
                  alt="Scanned"
                ...
                {result.detections &&
                  result.detections.map((det, idx) => {
                    ...
                    // Convert absolute bounding box pixel coordinates to percentages of the image size
                    ...
                    return (
                      <div
                        key={idx}
                        className="absolute border-2 border-[#00ff00] bg-[#00ff00]/20 pointer-events-none"
                        style={{ left, top, width, height }}
                      >
                        <span className="absolute -top-[18px] left-[-2px] bg-[#00ff00] text-black text-[8px] font-bold px-1 whitespace-nowrap">
